...
<template>
  <main class="flex flex-col gap-y-10">
    <section class="">
    <div class="text-[190px] text-slate-100 mx-auto font-bold w-full flex justify-center m-0">404</div>
    <div class="container flex items-center px-6 py-1 mx-auto">
        <div class="flex flex-col items-center max-w-sm mx-auto text-center">
            ...
            <div class="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                <RouterLink to="/" class="w-1/2 px-5 py-2 text-sm flex space-x-2 tracking-wide  transition-colors duration-200 rounded-lg shrink-0 sm:w-auto bc">
