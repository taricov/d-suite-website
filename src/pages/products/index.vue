  ...
  <main class="flex flex-col gap-y-10">
    <div class="w-full p-4 bg-slate-700/20 rounded-lg shadow sm:p-6">
        ...
        <ul class="my-4 space-y-3">
          <li>
                <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50/5 hover:bg-gray-100/10 group hover:shadow transition duration-300 dark:text-white">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap text-3xl">D-Notes</span>
                    <span class="inline-flex text-md items-center justify-center px-2 py-0.5 ml-3 font-medium rounded bg-gray-900/30 text-gray-400">Popular</span>
                </a>
            </li>
        </ul>
    </div>
